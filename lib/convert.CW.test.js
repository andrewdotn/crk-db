...
describe(`CW conversion script`, function() {
  ...
  context(`\\def`, function() {
    ...
    it(`extracts cross-references: [see XXX]`, function() {
      ...
      expect(crossRef.relation).to.equal(`crossRef`);
    ...
    it(`extracts extended cross-references as notes: [see XXX …]`, function() {
      ...
      expect(sense.definition).to.equal(`greatly, extremely, overwhelmingly, tremendously, to an extraordinary extent; with startled surprise`);
