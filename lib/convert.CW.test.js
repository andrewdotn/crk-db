...
describe(`CW conversion script`, function() {
  ...
  context(`\\def`, function() {
    ...
    it(`extracts multiple notes within a parenthetical`);

    it.skip(`extracts multiple parentheticals across definitions`, function() {

      // young macôhow, Bad Owl's son [male name]; [plural:] Bad Owl's family, members of Bad Owl's family
