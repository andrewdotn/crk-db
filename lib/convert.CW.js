...
function processNote(noteText, entry, sense) {
  processCrossReference(noteText, entry, sense);
  processLiteralDefinition(noteText, entry, sense);
  processLatinTerm(noteText, entry, sense);
  processUsageNote(noteText, entry, sense);
