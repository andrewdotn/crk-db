...
async function buildDatabase() {
  ...
  const assignParadigmsSpinner = createSpinner(`Assigning paradigms.`).start();
  await assignParadigms(databasePath, databasePath);
  assignParadigmsSpinner.succeed(`Paradigms assigned.`);
}
